...
[[https://github.com/zentrope/cluj/releases/tag/v0.5.0][Version 0.5.0]].
...
is the Clojure REPL.
 ...
 - [[https://github.com/hierynomus/sshj][sshj]] :: A java lib for SSH related stuff. [4.1]

 - [[https://github.com/Alexey1Gavrilov/ExpectIt][ExpectIt]] :: Expect lib for remote connections, like sshj. [4.1]

 - javamail :: Java lib for sending email. [4.1]

 - hiccup :: Lib for creating XML/HTML via clojure data structures. [4.1]

 - tools.logging :: A lib abstracting over an assortment of JVM
      logging libraries.

 - logback :: One of those logging libraries.

 - p/schema :: Prismatic/Plumatic schema.
